...
class Layer:
    ...
    def backprop(self, grads, do_d_inp=True):
        ...
        :param grads: The Gradients from the next layer.
        :param do_d_inp: To specify if gradients for the previous layer are to be calculated or not.(Bool)
        :return: The gradients for the previous layer.
        """
        pass

class InputLayer(Layer):
    """
    Just a placeholder for input do_d_inp.
    """
